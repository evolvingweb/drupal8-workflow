 ...
 * @endcode
 */
$settings['hash_salt'] = 'zlGmhHIGNnT7AVfDvqIWaZTQordgiIavG4xec4dMk7rRAIZ1MF0qUwQ9nv58hTgubTq02niCKg';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_mario_workstation_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_mario_workstation_dd.inc';
}
// </DDSETTINGS>
$databases['default']['default'] = array (
  'database' => 'mario_workstation',
  'username' => 'root',
  'password' => '',
  'prefix' => '',
  'host' => '127.0.0.1',
